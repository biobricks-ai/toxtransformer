...
model = me.MoE.load("cache/train_multitask_transformer_parallel/models/step_16000").to(device).eval()
...
for task_idx, (minprops, (nprops, prop)) in tqdm(minprop_prop_iter, total=total_tasks):
